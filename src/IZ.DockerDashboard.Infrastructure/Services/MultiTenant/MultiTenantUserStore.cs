    ...
    ApplicationRoleClaim>
{
    ...
    private  Task<ApplicationRole?> GetRoleAsync(string normalizedRoleName, CancellationToken cancellationToken)
    {
        return  Context.Roles.FirstOrDefaultAsync(r => r.NormalizedName == normalizedRoleName, cancellationToken);
    }
